...
RooZPtPdf::RooZPtPdf(const char *name, const char *title, RooAbsReal & _zpt,
		...
		RooAbsReal & _a4, RooAbsReal & _b4,
		RooAbsReal & _c4, RooAbsReal & _d4, RooAbsReal & _merge) :
	...
	a4("a4", "a4", this, _a4), b4("b4", "b4", this, _b4),
	c4("c4", "c4", this, _c4), d4("d4", "d4", this, _d4), merge("merge", "merge", this, _merge) {}
...
RooZPtPdf::RooZPtPdf(const RooZPtPdf& other, const char* name) : 
		...
		a4("a4",this,other.a4), b4("b4",this,other.b4),
		c4("c4",this,other.c4), d4("d4",this,other.d4), merge("merge",this,other.merge) {}



Double_t RooZPtPdf::evaluate() const {
	return ptFunc(a1, b1, c1, d1, b2, c2, b3, c3, a4, b4, c4, d4, zpt, merge);
}
